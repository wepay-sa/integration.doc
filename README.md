...
| -------------- | --------------------------------------------------------------------------- |
| Minor (v1.5.0) | Unified refund API for full/partial refunds at contract and milestone level |
...
| 400    | Validation failed, invalid status, invalid amount, or another active refund already exists |
| 401    | Unauthorized                                                                               |
